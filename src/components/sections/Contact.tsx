...
const SOCIAL_LINKS: SocialLink[] = [
  {
    id: "email",
    name: "Email",
    url: "mailto:dimaszalif3@gmail.com",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
  ...
  },
  {
    id: "github",
    name: "GitHub",
    url: "https://github.com/dimasz555",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
  ...
  },
  {
    id: "linkedin",
    name: "LinkedIn",
    url: "https://linkedin.com/in/dimaszaidanalif",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
  ...
  },
  {
    id: "instagram",
    name: "Instagram",
    url: "https://instagram.com/diimasz._",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
...
export default function Contact() {
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute right-1/3 top-1/4 h-125 rounded-full bg-primary/5 blur-[120px]"
      />
      ...
      <div className="relative mx-auto max-w-4xl px-6 lg:px-8">
        ...
        >
          <div className="mb-12 text-center">
            ...
            >
              Saya terbuka untuk diskusi proyek, kolaborasi, atau sekadar ngobrol
              tentang teknologi
            </motion.p>
          </div>
          ...
          <motion.div variants={slideUpVariants} className="text-center">
            <a
              ...
              download
              className={cn(
                "inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 font-semibold text-primary-foreground",
